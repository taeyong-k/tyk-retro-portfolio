// ✅ 초안:
// 사용 애니메이션: 인터렉티브 이미지 갤러리, CSS Block Reveal, 그라디언트 보더, 이미지 슬라이드, 마우스 오버하면 빛나는 효과 등
// 하나하나 수정 작업 거쳐서 초안 완성
...
// ✅ 프로젝트 섹션 완성본 _V2 (+모바일 반응형)
// (딱 단점 하나! 모바일 변경시 갤러리 등장애니메이션 때문에 공백 시간이 있다는것...)
// import {projectsData} from './projectData.js';
//
// window.AppState = window.AppState || {
//     isScrolling: false,
...
// ✅ 모바일까지 수정 완료
// 문제!!! 브라우저별 차이로 인한 갤러리 이미지 위치 튐 현상
import {projectsData} from './projectData.js';
